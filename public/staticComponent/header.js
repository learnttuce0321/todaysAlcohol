...
<i class="fa-solid fa-martini-glass-citrus"></i>
    ...
    <div class='navbar-menu'>
        <div class='navbar-left'>
            ...
            <li><a href="/community/:{category}">게시판</a></li>
        </div>
...
window.addEventListener('resize', () => {
  ...
  if (windowWidth <= 820 ) {
    ...
    document.querySelector('.navbar-togglebtn').classList.replace('disappear','show');
  } else if (windowWidth > 820 ) {
      document.querySelector('.navbar-togglebtn').classList.replace('show','disappear');
      document.querySelector('.navbar-menu').classList.remove('disappear','toggle');}
});
